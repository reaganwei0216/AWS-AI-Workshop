...
## Prerequisites
  ...
  - Fulfill previous tutorial : [Create a Chatbot and Configure with Intent and Slot type](../01-Build-an-Amazon-Lex-Bot/101-Create-a-Chatbot-and-Configure-with-Intent-and-Slot-type.md)
